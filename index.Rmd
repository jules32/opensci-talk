---
title: "Improving reproducibility, collaboration, and communication in marine science using open science tools"
output:
...
we can be working more efficiently, collaboratively, and reproducibly than we are

<!---This talk is about reproducibility. 
...
We made these changes incrementally over 3.5 years and are still improving; can't be an all-at once thing! --->

## Outline

- Improved reproducibility, collaboration and communication with the Ocean Health Index with open science tools
    <!---We were not able to fully reproduce our own work when we tried.  --->
